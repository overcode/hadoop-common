...
Apache Hadoop(tm) is an open source Java framework for processing and querying vast amounts of data on large clusters of commodity hardware. Hadoop is a top level Apache project, initiated and led by Yahoo!. It relies on an active community of contributors from all over the world for its success.
...
h3. Hadoop Distribution of Hadoop with security 0.20.104.2
...
See "YAHOO-CHANGES.txt":releases/0.20.104.2/YAHOO-CHANGES.txt for full details. "Previous versions":download.html are also available.
